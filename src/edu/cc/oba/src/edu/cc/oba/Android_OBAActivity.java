...
public class Android_OBAActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (settings.contains("user")) {
			...
			Intent myIntent = new Intent(Android_OBAActivity.this,
					mainUITabs.class);
			...
			final EditText user_name = (EditText) this
					.findViewById(R.id.username);
			final EditText pass_word = (EditText) this
			...
			logIn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					try {
						...
						Toast.makeText(getBaseContext(), "Check your Password",
								4).show();
						auth = false;
