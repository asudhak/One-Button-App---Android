...
//          	  Toast.makeText(getBaseContext(), ((TextView)v.findViewById(R.id.lngValue)).getText().toString(),4).show();  	  
            	...
            	final int request_id=Integer.parseInt (((TextView)v.findViewById(R.id.tab3_hidden_req)).getText().toString());
          	  
//          	  Toast.makeText(getBaseContext(), arg0.findViewById(R.id.lngValue).getResources().toString(),4).show();
          	  
            AlertDialog.Builder adb = new AlertDialog.Builder(createConnection.this);
            adb.setCancelable(true);
            
            
            
            adb.setNeutralButton("Extend", new DialogInterface.OnClickListener(){
          	  @Override
            ...
            adb.setPositiveButton("Delete Reservation", new DialogInterface.OnClickListener(){
    ...
    public void updateListView()
    {
   		...
   		int[] to = {R.id.tab3_imageName, R.id.tab3_status ,R.id.tab3_time, R.id.tab3_hidden_req};
		...
		scanTask = new TimerTask() {
		        public void run() {
		                handler.post(new Runnable() {
		                        public void run() {
		                        	Toast.makeText(getBaseContext(), "List Updated", 4).show();
		                        	updateListView();
